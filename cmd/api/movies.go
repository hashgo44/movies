...
func (app *application) createMovieHandler(w http.ResponseWriter, r *http.Request) {
	...
	// Inclure un en-tête Location pour indiquer au client à quelle URL il peut trouver la ressource nouvellement créée.
	headers := make(http.Header)
	headers.Set("Location", fmt.Sprintf("/v1/movies/%d", movie.ID))

	// Écris une réponse JSON avec un code 201, les données du film et le headers Location
